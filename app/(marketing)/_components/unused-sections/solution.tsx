...
const features = [
    ...
    content: (
      <>
        ...
        <Safari
          src="/dashboard.png"
          url="https://cybershield.ai"
          className="-mb-48 mt-16 ml-12 h-full select-none px-4 drop-shadow-[0_0_28px_rgba(0,0,0,.1)] transition-all duration-300 group-hover:translate-x-[-10px]"
        />
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <Ripple className="-bottom-full absolute" />
        <Safari
          src="/dashboard.png"
          url="https://cybershield.ai"
          className="-mb-32 mt-4 max-h-64 w-full select-none px-4 drop-shadow-[0_0_28px_rgba(0,0,0,.1)] transition-all duration-300 group-hover:translate-y-[-10px]"
