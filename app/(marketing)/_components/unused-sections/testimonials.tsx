...
export function TestimonialCard({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="select-none font-normal text-neutral-700 text-sm dark:text-neutral-400">
        {description}
      ...
      <div className="flex w-full select-none items-center justify-start gap-5">
        ...
        <div>
          ...
          <p className="font-normal text-neutral-400 text-xs">{role}</p>
        </div>
      </div>
    </div>
  );
...
const testimonials = [
  {
    ...
    description: (
      <p>
        The AI-driven analytics from #nexus.ai have revolutionized our security
        assessment process.
        <Highlight>
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        <Highlight>
          We've seen a 70% reduction in successful breach attempts!
        </Highlight>{" "}
  ...
  },
  {
    ...
    description: (
      <p>
        As a startup, we need robust security without breaking the bank.
        #nexus.ai&apos;s automated pentesting helps us do just that.
        <Highlight>Our security confidence has doubled.</Highlight> Essential
        tool for any security-conscious startup.
      </p>
    ),
  },
  {
    ...
    description: (
      <p>
        #nexus.ai&apos;s AI-driven compliance mapping has made meeting
        regulatory requirements a breeze.
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        <Highlight>
          Our incident response time has decreased by 60% with real-time AI
          insights.
        </Highlight>{" "}
  ...
  },
  {
    ...
    description: (
      <p>
        By integrating #nexus.ai&apos;s continuous security testing, we&apos;ve
        seen a significant reduction in our attack surface.
        <Highlight>
  ...
  },
  {
    ...
    description: (
      <p>
        ...
        <Highlight>
          Our security strategy is now data-driven with higher threat prevention
          rates.
        </Highlight>{" "}
  ...
  },
  {
    ...
    description: (
      <p>
        Implementing #nexus.ai in our healthcare systems has improved patient
        data protection significantly.
        <Highlight>
          AI and healthcare security working hand in hand for better patient
          trust.
        </Highlight>{" "}
  ...
  },
  {
    ...
    description: (
      <p>
        #nexus.ai&apos;s AI-driven security assessments have doubled our ability
  ...
  },
  {
    ...
    description: (
      <p>
        #nexus.ai&apos;s AI has streamlined our incident response process,
        enhancing our security posture and operational efficiency.
        <Highlight>
          Bringing AI and human expertise together in cybersecurity.
        </Highlight>{" "}
  ...
  },
  {
    ...
    description: (
      <p>
        #nexus.ai&apos;s insights into startup security landscapes have been
        invaluable for our members&apos; growth and investor confidence.
        <Highlight>
          Empowering startups with AI-driven security assessments.
        </Highlight>{" "}
